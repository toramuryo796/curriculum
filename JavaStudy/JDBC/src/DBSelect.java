...
public class DBSelect {
 ...
 private static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/44Test";
 /** ・ユーザー名 */
 ...
 String SQL = "SLECT * FROM TB_SHOHIN WHERE SHOHIN_ID = '001' OR SHOHIN_ID = '020'" ;
 resultSet = statement.executeQuery(SQL);

 while (resultSet.next()) {
  // 問⑥ それぞれカラム名を入力してください。
 String column1 = resultSet.getString("SHOHIN_ID");
 String column2 = resultSet.getString("SHOHIN_NMAE");
